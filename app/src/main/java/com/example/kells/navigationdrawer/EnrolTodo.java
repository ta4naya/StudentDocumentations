 ...
 */
public class EnrolTodo extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        groups = new String[] { "REQUIREMENTS","GETTING INSURANCE", "ORIGINAL DOCUMENTS", "FEES PAYMENT", "ENROLLMENT" };
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.enrollment_layout, container, false);
